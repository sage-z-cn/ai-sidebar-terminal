...
- README is bilingual: `README.md` (English) and `README.zh-cn.md` (Chinese). Any change to one must be mirrored in the other. Marketplace locale README uses lowercase `zh-cn` (matching `package.nls.zh-cn.json`).
